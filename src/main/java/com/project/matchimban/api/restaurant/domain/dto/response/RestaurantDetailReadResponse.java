...
public class RestaurantDetailReadResponse {
    ...
    public static RestaurantDetailReadResponse createRestaurantDetailReadResponse(Restaurant restaurant) {
        return RestaurantDetailReadResponse.builder()
                .id(restaurant.getId())
