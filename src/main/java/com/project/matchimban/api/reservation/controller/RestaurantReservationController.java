...
import com.project.matchimban.TestRes;
...
public class RestaurantReservationController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "40000-31001", description = "실패: 매장 정보가 없는 경우"),
            @ApiResponse(responseCode = "40000-31002", description = "실패: 이미 등록된 경우")
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "40000-31003", description = "실패: 등록된 예약 시스템이 없는 경우")
    })
